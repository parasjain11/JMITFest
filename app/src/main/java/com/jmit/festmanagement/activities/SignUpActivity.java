...
public class SignUpActivity extends BaseActivity {
    ...
    EditText rollno, name, phoneno, email, cemail;
    Button signup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rollno.getText().toString().matches("") || name.getText().toString().matches("") || department.getSelectedItemPosition()==0 || phoneno.getText().toString().matches("") || email.getText().toString().matches("") || cemail.getText().toString().matches("")) {
                    allvalid=false;
